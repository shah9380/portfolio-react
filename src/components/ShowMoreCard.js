const ShowMoreCard = ()=>{
    return(
        <div className="border border-black/50 bg-black/30 text-white/75 p-4 text-start flex flex-col gap-4 rounded-xl">
            <div className="flex flex-col gap-4">
                <div className=""><p>Hello there! 👋 My name is Misbah and I'm from Bida, Karnataka. As a Full-Stack software developer, I specialize in creating visually appealing websites, apps and mobile games. My passion for creating dynamic just a hobby, it's a key ingredient in every project I work on.</p></div>
            ...
            <button className="hidden">Hide Text</button>
        </div>
    )
}
